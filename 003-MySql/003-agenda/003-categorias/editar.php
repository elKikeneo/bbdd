...
if(isset($_GET['c'])){
    switch ($_GET['c']){
        case 1:
            ...
            break;
        case 2:
            $mng="Ya existe un contacto con este teléfono";
            break;
    }
}
                ...
                if ($nfilas > 0) { ?>
                    ...
                    <?php for ($i = 0; $i < $nfilas; $i++) { ?>
                        <?php $fila = mysqli_fetch_array($result) ?>
                            ...
                            <!--Añado e atributo selected a aquel option que vaya a mostrar la categoría que originalmente tiene el contacto asignado-->
